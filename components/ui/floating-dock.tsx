  ...
  return (
    <div className={cn("fixed bottom-4 right-4 z-50 md:hidden", className)}>
            ...
            {items.map((item, idx) => (
              ...
              >
                <Link
                  href={item.href}
                  key={item.title}
                  className="h-10 w-10 rounded-full bg-yellow-300 dark:bg-yellow-600 flex items-center justify-center"
                >
      ...
      <button
        ...
        className="h-10 w-10 rounded-full bg-yellow-300 dark:bg-yellow-800 flex items-center justify-center"
      >
