      ...
      <div className="min-h-screen flex items-center justify-center px-4 py-8 sm:px-6 sm:py-12 md:px-8 md:py-16">
        <div className="max-w-md w-full mx-auto rounded-lg md:rounded-2xl p-4 md:p-8 shadow-input bg-white/30 dark:bg-black/30 backdrop-blur"> 
          ...
          <p className="text-neutral-600 text-sm max-w-sm mt-2 dark:text-neutral-300">
            Login to GalleryArts to get inspiration you need
          </p>
          ...
          <form className="my-8" onSubmit={handleSubmit}>
            ...
            <div className="flex flex-col md:flex-row space-y-2 md:space-y-0 md:space-x-2 mb-4">
              <button
                ...
                type="submit"
              >
                <IconBrandGithub className="h-4 w-4 text-[#48CFCB] dark:text-neutral-300" />
              ...
              <button
                ...
                type="submit"
              >
                <IconBrandGoogle className="h-4 w-4 text-[#48CFCB] dark:text-neutral-300" />
                <span className="text-neutral-700 dark:text-neutral-300 text-sm">
                  Google
                </span>
                <BottomGradient />
...
const BottomGradient = () => {
  return (
    <>
      <span className="group-hover/btn:opacity-100 block transition duration-500 opacity-0 absolute h-px w-full -bottom-px inset-x-0 bg-gradient-to-r from-transparent via-[#48CFCB] to-transparent" />
      <span className="group-hover/btn:opacity-100 blur-sm block transition duration-500 opacity-0 absolute h-px w-1/2 mx-auto -bottom-px inset-x-10 bg-gradient-to-r from-transparent via-[#48CFCB] to-transparent" />
    </>
  );
};
